...
import { QuestionFactory } from "./classes/QuestionClasses/QuestionFactory.js";
...
function testJson(){
    ...
    const aIQuizGenerator = new AIQuizGenerator(questionFactory, formBuilder, json_question);
    aIQuizGenerator.generateQuiz();
}
testJson();
// testGemini();
